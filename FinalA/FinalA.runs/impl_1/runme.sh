...
HD_PWD='E:/nchu/Vivado/FinalA/FinalA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Smart_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Smart_Top.tcl -notrace
