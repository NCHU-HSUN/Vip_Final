...
HD_PWD='E:/nchu/Vivado/FinalA/FinalA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Smart_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Smart_Top.tcl
